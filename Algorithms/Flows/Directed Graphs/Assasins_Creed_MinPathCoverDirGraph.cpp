...
/*
	In this problem we need to find a path cover in a general dir.graph, with no
	requirement of vertex-disjointedness. Hence, just compress the directed graph
	into a dag by condensing scc's to a single node.
	After this, perform transitive closure on the dag.
